...
export default function Home() {
  return (
    <div>
      <div className="card">
        <h1 style={{ color: '#667eea', marginBottom: '1rem' }}>Welcome to QuietLedger</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginTop: '2rem' }}>
          <Link href="/holder" style={{ textDecoration: 'none' }}>
            <div className="card" style={{ cursor: 'pointer', background: '#f0f7ff', border: '2px solid #667eea' }}>
              <h3 style={{ color: '#667eea', marginBottom: '0.5rem' }}>👤 Holder</h3>
          ...
          <Link href="/verifier" style={{ textDecoration: 'none' }}>
            <div className="card" style={{ cursor: 'pointer', background: '#f9f0ff', border: '2px solid #764ba2' }}>
              <h3 style={{ color: '#764ba2', marginBottom: '0.5rem' }}>✓ Verifier</h3>
              <p>Register policies and verify passports against your tier requirements.</p>
            </div>
          </Link>
        </div>

        <div style={{ marginTop: '2rem', padding: '1rem', background: '#f0f7ff', borderRadius: '4px', borderLeft: '4px solid #667eea' }}>
          <h3 style={{ color: '#667eea', marginBottom: '0.5rem' }}>How It Works</h3>
        ...
        <div style={{ marginTop: '2rem', padding: '1rem', background: '#f5f5f5', borderRadius: '4px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem', marginTop: '1rem' }}>
            <div style={{ textAlign: 'center', padding: '1rem', background: 'white', borderRadius: '4px' }}>
